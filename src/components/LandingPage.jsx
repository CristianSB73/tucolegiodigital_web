                ...
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav ms-auto align-items-center fw-medium">
                            ...
                            <li className="nav-item me-3">
                                <button className="nav-link btn btn-link text-dark text-decoration-none nav-custom-link" onClick={() => scrollToSection('sinergia')}>¿Por qué nosotros?</button>
                            </li>
                            <li className="nav-item me-3">
                ...
                <div className="container position-relative" style={{ zIndex: 1 }}>
                    <div className="row align-items-center">
                        <div className="col-lg-6 text-center text-lg-start pe-lg-5">
                            <span className="badge bg-primary bg-opacity-10 text-primary px-3 py-2 rounded-pill mb-3 fw-bold tracking-wide border border-primary">
                                <i className="bi bi-link-45deg me-1"></i> Gestión Académica + Financiera Integrada
                            </span>
                        ...
                        <div className="col-lg-6 mt-5 mt-lg-0 position-relative">
                            ...
                            {/* Pequeña tarjeta flotante simulando Kodeca / Pagos */}
                ...
                <div className="container py-5">
                    ...
                    <div className="row align-items-center mb-5 pb-5 border-bottom">
                        <div className="col-lg-6 mb-4 mb-lg-0 pe-lg-5">
                            ...
                            <ul className="list-unstyled mb-4">
                                ...
                                <li className="mb-3 d-flex"><i className="bi bi-check-circle-fill text-primary me-3 fs-5"></i> <span><strong>Libro de Clases Digital:</strong> Control de asistencia en segundos.</span></li>
                                <li className="d-flex"><i className="bi bi-check-circle-fill text-primary me-3 fs-5"></i> <span><strong>Certificados Online:</strong> Descarga inmediata con firma electrónica.</span></li>
                            </ul>
                        </div>
                    ...
                    <div className="row align-items-center pt-3">
                        <div className="col-lg-6 order-2 order-lg-1 text-center">
                            {/* Si aún no tienes el mockup de kodeca, usa un placeholder visual */}
                        ...
                        <div className="col-lg-6 order-1 order-lg-2 mb-4 mb-lg-0 ps-lg-5">
                            ...
                            <ul className="list-unstyled mb-4">
                                ...
                                <li className="mb-3 d-flex"><i className="bi bi-check-circle-fill text-success me-3 fs-5"></i> <span><strong>Pagos con Tarjeta:</strong> Integración nativa con Mercado Pago.</span></li>
